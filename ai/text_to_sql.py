...
FORBIDDEN_WORDS = ['drop','delete','truncate','alter','update','insert','create','replace']

EXAMPLE_QUESTIONS = ["Top 10 cities by GMV",
                     "Which cuisin has the most orders",
                     'Average delivery time by city, best first',
...
FACT_ORDERS(order_id, order_date, customer_id, restaurant_id, city, cuisine,
...
question = st.text_input("Enter your question here", placeholder=EXAMPLE_QUESTIONS[0])
